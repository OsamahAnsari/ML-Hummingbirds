...
public class FlowerArea : MonoBehaviour
{
    ...
    private System.Collections.Generic.List<GameObject> flowerPlants;
    ...
    /// </summary>
    public System.Collections.Generic.List<Flower> Flowers { get; private set; }
    ...
    {
        // Rotate each flower point around the Y axis and subtly around X and Z
    ...
    private void Awake()
    {
        ...
        flowerPlants = new System.Collections.Generic.List<GameObject>();
        nectarFlowerDictionary = new Dictionary<Collider, Flower>();
        Flowers = new System.Collections.Generic.List<Flower>();
    ...
    private void Start()
    {
        // Used to have FindChildFlowers, now in Awake
    }
